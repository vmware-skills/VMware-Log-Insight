...
``VMWARE_LOG_INSIGHT_CONFIG``, then ``CONFIG_FILE`` — was consolidated into
...
from vmware_log_insight.config import CONFIG_FILE, resolve_config_path

_ENV = "VMWARE_LOG_INSIGHT_CONFIG"
