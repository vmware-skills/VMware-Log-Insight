...
def resolve_config_path(config_path: Path | None = None) -> Path:
    ...
    again in :func:`vmware_log_insight.doctor.run_doctor`, and the doctor's copy
    had no env-var clause — so with ``VMWARE_LOG_INSIGHT_CONFIG`` set it
    reported on a file the tools would never open, and passed (2026-08-30). Two
